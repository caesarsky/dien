...
class Model(object):
    ...
    def auxiliary_loss(self, h_states, click_seq, noclick_seq, mask, stag = None):
        ...
        click_loss_ = - tf.reshape(tf.log(click_prop_+0.00000001), [-1, tf.shape(click_seq)[1]]) * mask
        noclick_loss_ = - tf.reshape(tf.log(1.0 - noclick_prop_+0.00000001), [-1, tf.shape(noclick_seq)[1]]) * mask
